...
# SFML_LIBRARIES, the name of the librarys to link against
# SFML_INCLUDE_DIRS, where to find SFML headers
#
...
FOREACH(COMPONENT ${SFML_COMPONENTS})
   ...
   IF(SFML_${UPPERCOMPONENT}_INCLUDE_DIR)
      ...
      LIST(APPEND SFML_INCLUDE_DIRS ${SFML_${UPPERCOMPONENT}_INCLUDE_DIR})
      LIST(REMOVE_DUPLICATES SFML_INCLUDE_DIRS)
...
FOREACH(MODE ${SFML_MODE})
   ...
   FOREACH(COMPONENT ${SFML_COMPONENTS})      
      ...
      FIND_LIBRARY(SFML_${UPPERCOMPONENT}_LIBRARY${MODE}
         ...
         PATHS ${SFML_LIBRARIES_SEARCH_DIR}
      )
   ENDFOREACH(COMPONENT)
...
#We also fill SFML_LIBRARIES here with all the files we like to link to
...
LIST(APPEND SFML_LIBRARIES ${SFML_MAIN_LIBRARY${MODE_LABEL}})
...
FOREACH(COMPONENT ${SFML_FIND_COMPONENTS})
   ...
   ELSE(NOT ${MODUL_NAME})
      LIST(APPEND SFML_LIBRARIES ${${MODUL_NAME}})
   ENDIF(NOT ${MODUL_NAME})
ENDFOREACH(COMPONENT)

LIST(REMOVE_DUPLICATES SFML_LIBRARIES)

INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(SFML DEFAULT_MSG SFML_LIBRARIES SFML_INCLUDE_DIRS)
